 ...
 * Use the {@link NotificationsFragment2#newInstance} factory method to
...
public class NotificationsFragment2 extends Fragment {
    ...
    private static final String TAG = "NotificationsFragment2";
     ...
     * @return A new instance of fragment NotificationsFragment2.
     */
    // TODO: Rename and change types and number of parameters
    public static NotificationsFragment2 newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        view.findViewById(R.id.text).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyApplication.addToBackStack(R.id.navigation_notifications3);
                Navigation.findNavController(v).navigate(R.id.navigation_notifications3);
            }
        });
    }
}
